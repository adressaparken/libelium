...
void loop() {
  ...
  for (int i = 0; i < SNAPSHOTS; i++) {             // LOOP
    t += gas_PRO_sensor.getTemp();                  // READ VALUES
  } 
  t /= SNAPSHOTS;                                   // CALCULATE AVERAGE
  temperature[loopCounter] = t;                     // UPDATE VARIABLE
  //========================================================================
  ...
  humidity[loopCounter] = h;                        // UPDATE VARIABLE
  //========================================================================
  ...
  pressure[loopCounter] = p;                        // UPDATE VARIABLE
 //========================================================================
  ...
  co2loopCounter] = c;                              // UPDATE VARIABLE
  //========================================================================
  ...
  fLuminosity[loopCounter] = l;                   // UPDATE ARRAY
  //======================================================================== 
  ...
  frame.addSensor(SENSOR_CITIES_PRO_TC, fTemperature);      // Add temperature
  frame.addSensor(SENSOR_CITIES_PRO_HUM, fHumidity);        // Add humidity
  frame.addSensor(SENSOR_CITIES_PRO_PRES, fPressure);       // Add pressure value
  ...
  frame.addSensor(SENSOR_CITIES_PRO_CO2, fCO2);             // Add CO2 ¨

  frame.addSensor(TSL, fLuminosity);      // ????? IS THIS THE RIGHT KEYWORD
  frame.addSensor(RTC); // ADD TIME
